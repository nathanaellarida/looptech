...
const COURSE_DETAIL = {
  ...
  description:
    'Equip yourself with practical digital skills while addressing real-life online issues they face every day — from scams and fake news to creative digital projects that help their community.',
  content: [
    { title: 'Internet Basics', unlocked: true },
    { title: 'Smart Searching & Fake News', unlocked: false },
    { title: 'Online Scams and Privacy', unlocked: false },
    { title: 'Being a Responsible Netizen', unlocked: false },
    { title: 'Practical Digital Life Skills', unlocked: false },
  ],
};
  ...
  return (
    <div className="course-detail-page">
      ...
      <div className="course-detail-card">
        ...
        <img 
          src="/images/homepage/course-icon--4.png" 
          alt="Course Icon" 
                  ...
                  <span className="course-detail-list-icon-wrap">
                    {item.unlocked ? (
                      <img
                        ...
                        style={{ cursor: 'pointer' }}
                        onClick={() => navigate('/DigitalLiteracyHome')}
                      />
                    ) : (
